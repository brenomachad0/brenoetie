...
const I18N = {
  pt: {
    ...
    "gift.11.n": "Suborno pro sol aparecer", "gift.11.d": "Uma ajudinha pro tempo colaborar no grande dia. Se chover, vamos olhar feio pra quem não contribuiu. ☀️😄",
    "gifts.credits": "Fotos ilustrativas: David N Cooper, happyskrappy, Swami Stream, mrlins, Sam Howzit, tdlucas5000, MattJP e Horia Varlan (CC BY) · demais em domínio público (CC0) · via Openverse.",
  ...
  en: {
    ...
    "gift.11.n": "A bribe for good weather", "gift.11.d": "A little help so the weather behaves on the big day. If it rains, we're side-eyeing whoever skipped this one. ☀️😄",
    "gifts.credits": "Illustrative photos: David N Cooper, happyskrappy, Swami Stream, mrlins, Sam Howzit, tdlucas5000, MattJP and Horia Varlan (CC BY) · others public domain (CC0) · via Openverse.",
