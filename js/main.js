...
const I18N = {
  pt: {
    ...
    "details.reception.kicker": "Recepção", "details.reception.name": "Espaço Mocambo",
    "details.reception.addr": "SHIN · Lago Norte<br>Brasília — DF",
    ...
    "gifts.lead": "A presença de cada um de vocês é o nosso maior presente!<br><br>Já vivemos juntos há muitos anos e temos quase tudo em casa — só falta a mesa de jantar dos sonhos da Tiê (aquela de uns R$10 mil 😄).<br>Então reunimos estas opções pra realizar um sonho ainda maior: a nossa lua de mel.<br>As contribuições vão todas pra lá!<br>E qualquer presente físico escolhido com carinho também será muito bem-vindo.",
    "gifts.give": "Presentear",
    "gifts.paynote": "Ao escolher um presente, você vai para o pagamento seguro no Mercado Pago — cartão (parcelável) ou Pix. 💛",
    ...
    "gift.11.n": "Cota da próxima festa", "gift.11.d": "Uma cota pra que a próxima festa seja feita com bem mais antecedência — dessa vez a gente não conseguiu mais esperar. 🥰🎉",
    "gift.12.n": "A mesa dos sonhos da Tiê", "gift.12.d": "Vai que, né? 😅 O sonho de consumo da Tiê. Se alguém realizar, você ganha lugar cativo à nossa mesa pra sempre!",
    "gifts.credits": "Fotos ilustrativas: David N Cooper, happyskrappy, Swami Stream, mrlins, Sam Howzit, tdlucas5000, MattJP, teapotqueen e Haldane Martin (CC BY) · demais em domínio público (CC0) · via Openverse.",
  ...
  en: {
    ...
    "details.reception.kicker": "Reception", "details.reception.name": "Espaço Mocambo",
    "details.reception.addr": "SHIN · Lago Norte<br>Brasília — DF",
    ...
    "gifts.lead": "Each one of you being here is our greatest gift!<br><br>We've been together for many years and have almost everything at home — all that's missing is Tiê's dream dining table (the ~R$10k kind 😄).<br>So we've gathered these options for an even bigger dream: our honeymoon.<br>All contributions go straight there!<br>And any physical gift chosen with love is always welcome too.",
    "gifts.give": "Gift this",
    "gifts.paynote": "Picking a gift takes you to secure checkout on Mercado Pago — card (installments) or Pix. 💛",
    ...
    "gift.11.n": "Next-party fund", "gift.11.d": "A little fund so the next party gets planned way earlier — this time we just couldn't wait any longer. 🥰🎉",
    "gift.12.n": "Tiê's dream table", "gift.12.d": "A long shot, we know 😅 — Tiê's ultimate wishlist item. Pull it off and you get a seat at our table forever!",
    "gifts.credits": "Illustrative photos: David N Cooper, happyskrappy, Swami Stream, mrlins, Sam Howzit, tdlucas5000, MattJP, teapotqueen and Haldane Martin (CC BY) · others public domain (CC0) · via Openverse.",
