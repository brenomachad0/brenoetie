...
const I18N = {
  pt: {
    ...
    "gift.7.n": "Um tijolo do nosso lar", "gift.7.d": "Você faz parte da casa que estamos construindo.",
    "gift.8.n": "A primeira dança", "gift.8.d": "Aquela música, a gente rodando, o mundo parando.",
    "gifts.credits": "Fotos ilustrativas: David N Cooper, happyskrappy, Swami Stream, mrlins e Sam Howzit (CC BY) · demais em domínio público (CC0) · via Openverse.",
  ...
  en: {
    ...
    "gift.7.n": "A brick for our home", "gift.7.d": "You'll be part of the home we're building together.",
    "gift.8.n": "The first dance", "gift.8.d": "That song, the two of us spinning, the world on pause.",
    "gifts.credits": "Illustrative photos: David N Cooper, happyskrappy, Swami Stream, mrlins and Sam Howzit (CC BY) · others public domain (CC0) · via Openverse.",
