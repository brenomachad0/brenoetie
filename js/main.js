...
const I18N = {
  pt: {
    ...
    "gifts.lead": "A presença de cada um de vocês é o nosso maior presente!<br><br>Já vivemos juntos há muitos anos e temos quase tudo em casa — só falta a mesa de jantar dos sonhos da Tiê (aquela de uns R$10 mil 😄). Então reunimos estas opções pra realizar um sonho ainda maior: a nossa lua de mel. As contribuições vão todas pra lá! E qualquer presente físico escolhido com carinho também será muito bem-vindo.",
  ...
  en: {
    ...
    "gifts.lead": "Each one of you being here is our greatest gift!<br><br>We've been together for many years and have almost everything at home — all that's missing is Tiê's dream dining table (the ~R$10k kind 😄). So we've gathered these options for an even bigger dream: our honeymoon. All contributions go straight there! And any physical gift chosen with love is always welcome too.",
