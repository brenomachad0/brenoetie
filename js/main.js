...
const I18N = {
  pt: {
    ...
    "gifts.lead": "A presença de cada um de vocês é o nosso maior presente!<br><br>E como imaginamos que muitos de vocês já estão a fim de nos mimar 💛, adiantamos: as contribuições serão destinadas à nossa lua de mel. Também receberemos com muito carinho qualquer presente físico escolhido especialmente para nós.",
  ...
  en: {
    ...
    "gifts.lead": "Each one of you being here is our greatest gift!<br><br>And since we imagine many of you are already itching to spoil us 💛, here's the scoop: all contributions will go toward our honeymoon. We'll also lovingly welcome any physical gift chosen especially for us.",
